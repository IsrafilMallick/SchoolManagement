    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="GenderEntry.php"><i class="fa fa-edit"></i> Gender Entry</a></li>
                            <li><a href="CasteEntry.php"><i class="fa fa-edit"></i> Caste Entry</a></li>
                            <li><a href="ReligionEntry.php"><i class="fa fa-edit"></i> Religion Entry</a></li>
                            <li><a href="RelationEntry.php"><i class="fa fa-edit"></i> Relation Entry</a></li>
                            <!--
                    ...
                    <?php }?>
                    <li class="treeview">
                        <a href="#"><i class="fa fa-book"></i> <span>Class Management</span><i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                    		<li><a href="ClassEntry.php"><i class="fa fa-edit"></i> Class Entry</a></li>
                    		<li><a href="SectionEntry.php"><i class="fa fa-edit"></i> Section Entry</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="AdmissionEnquiry.php"><i class="fa fa-search"></i> Admission Enquery</a></li>
					<li><a href="AdmissionEnquiryList.php"><i class="fa fa-list-ol"></i> Enquiry List</a></li>
                </ul>
            </li>
            <?php }?>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="StudentEntry.php"><i class="fa fa-child fa-lg"></i> Student Entry</a></li>
                    <li><a href="StudentList.php"><i class="fa fa-list-ol"></i> Student List</a></li>
					<li><a href="FeesGenerate.php"><i class="fa fa-credit-card"></i> Fees Genearate</a></li>
                    <?php if($userlevel<0){?>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="AccountGroup.php"><i class="fa fa-users"></i> Group Head</a></li>
                            <li><a href="LedgerHead.php"><i class="fa fa-database"></i> Ledger Head</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="PayModeSetup.php"><i class="fa fa-cog"></i>Pay Mode Setup</a></li>
                            <li><a href="FeesHeadSetup.php"><i class="fa fa-cog"></i>Fees Head Setup</a></li>
                            <li><a href="FeesSetup.php"><i class="fa fa-cog"></i>Fees Setup</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#"><i class="fa fa-briefcase"></i> <span>Collections</span><i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu">
                            <li><a href="FeesCollect.php"><i class="fa fa-briefcase"></i>Collect Fess</a></li>
                    		<?php if($userlevel<0){?>
