...
if($SectionName==""){$SectionName1="";}else{$SectionName1="AND SectionName LIKE '%$SectionName%'";}
...
$rcnt=$rcntttl;
$sql=mysqli_query($con,"SELECT * FROM $tblnm WHERE sl>0 $Session1 $Class1 $SectionName1 ORDER BY sl ASC LIMIT $start,$ps") or die(mysqli_error($con));
...
if($count>0)
{
	...
	while($R=mysqli_fetch_array($sql))
	{
		...
		<tr>
            ...
            <td id="tblbody">
            <a href="SectionEntry.php?sl=<?=$sl;?>"><i class="fa fa-edit fa-lg" title="Click to Edit" style="cursor:pointer;"></i></a>
            <span id="show<?=$sl;?>">
