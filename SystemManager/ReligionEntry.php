...
$sql=mysqli_query($con,"SELECT religion FROM $tblnm WHERE sl='$sl'");
...
<form name="form1" id="form1" method="post" action="ReligionEntrys.php">
...
function show()
{
	...
	$('#show').load('ReligionEntryShow.php?religion='+religion).fadeIn('fast');
}
</script>