...
if($PackageName==""){$PackageName1="";}else{$PackageName1="AND PackageName LIKE '%$PackageName%'";}

$table='coursepackage';
$sql=mysqli_query($con,"SELECT * FROM $table WHERE sl>0 $PackageName1");
...
if($rcnt>0)
{
	...
	<tr>
		...
		<td id="tblhed" style="width:60%;">Package Name</td>
	...
	while($R=mysqli_fetch_array($sql))
	{
		...
		<tr>
        	...
        	<td id="tblbody"><?=$PackageName?></td>
        	<td id="tblbody">
        	<a href="CoursePackage.php?sl=<?=$sl;?>"><i class="fa fa-edit fa-lg" title="Click to Edit" style="cursor:pointer;"></i></a>
            <span id="show<?=$sl;?>">
