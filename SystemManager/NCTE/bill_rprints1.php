...
$prntcopy=$_REQUEST['prntcopy'];	if($prntcopy==''){$prntcopy=1;}
?>
...
for($i=0; $i<$prntcopy; $i++)
{
    ...
    <table border="1" width="800px" align="center" style="border: 4px solid #000000;">
    <tr>
    ...
    <tr>
        <td colspan="3" style="border:none;">
            ...
            <tr>
                ...
                <td id="tblhed1" style="width:20%;"><?=get_value('main_batch_setup','sl',$batch,'batch','',$con);?></td>
			</tr>
            <tr>
            ...
            $cnt=0;
            $Totamnt=0;
            $sql=mysqli_query($con,"SELECT * FROM main_drcr WHERE sesn='$sesn' AND sid='$sid' AND billno='$billno' AND paytyp='7'");
            while($R=mysqli_fetch_array($sql))
            {
                $cnt++;
				$mnth=$R['mnth'];
                ...
                <tr>
                    <td id="tblhed"><?=$cnt;?></td>
                    <td id="tblhed1"><?=get_value('account_ledg','sl',$crldgr,'ledgnm','',$con);?></td>
            ...
            <tr style="height:68px;">
                ...
                <td colspan="3" valign="top" align="right" style="font-size:16px; border:none; padding-top:5px;"><b>For, <?=strtoupper($cname);?></b></td>
            </tr>
            </table>
        </td>
    </tr>
