...
if($religion==""){$religion1="";}else{$religion1="AND religion LIKE '%$religion%'";}

$sql=mysqli_query($con,"SELECT * FROM $tblnm WHERE sl>0 $religion1");
...
if($rcnt>0)
{
	...
	<tr>
		...
		<td id="tblhed" style="width:60%;">Religion</td>
	...
	while($R=mysqli_fetch_array($sql))
	{
		...
		<tr>
        	...
        	<td id="tblbody"><?=$religion?></td>
        	<td id="tblbody">
        	<a href="ReligionEntry.php?sl=<?=$sl;?>"><i class="fa fa-edit fa-lg" title="Click to Edit" style="cursor:pointer;"></i></a>
            <span id="show<?=$sl;?>">
