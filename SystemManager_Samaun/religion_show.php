...
$table='main_religion';
$sql=mysqli_query($con,"SELECT * FROM $table WHERE sl>0 $religion1");
...
if($rcnt>0)
{
	...
	while($R=mysqli_fetch_array($sql))
	{
		...
		<tr>
        	...
        	<td id="tblbody">
        	<a href="religion.php?sl=<?=$sl;?>"><i class="fa fa-edit fa-lg" title="Click to Edit" style="cursor:pointer;"></i></a>
            <span id="show<?=$sl;?>">
