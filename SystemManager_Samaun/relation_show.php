...
$relation=$_REQUEST['relation'];	if($relation==""){$relation1="";}else{$relation1="AND relation LIKE '%$relation%'";}

$table='main_relation';
$sql=mysqli_query($con,"SELECT * FROM $table WHERE sl>0 $relation1");
...
if($rcnt>0)
{
	...
	while($R=mysqli_fetch_array($sql))
	{
		...
		<tr>
        	...
        	<td id="tblbody">
            <a href="relation.php?sl=<?=$sl;?>"><i class="fa fa-edit fa-lg" title="Click to Edit" style="cursor:pointer;"></i></a>
            <span id="show<?=$sl;?>">
