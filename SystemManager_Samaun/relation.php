...
$sql=mysqli_query($con,"SELECT relation FROM main_relation WHERE sl='$sl'");
...
<form name="form1" id="form1" method="post" action="relations.php">
...
function show()
{
	...
	$('#show').load('relation_show.php?relation='+relation).fadeIn('fast');
}
